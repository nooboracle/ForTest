...
void ASBotFightLayer::BladeMasterPreAttackCritical(){
    ...
    blade->setScaleX(-3);
    blade->setScaleY(3);
    blade->setPosition(ccp(size.width*36/70,winSize.height*34/70));
    addChild(blade,2);
...
void ASBotFightLayer::BladeMasterInAttackCritical(){
    ...
    CCCallFunc* hit = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::BladeMasterHitEnemyCritical));
    ...
    db->setScaleX(-3);
    db->setScaleY(3);
    db->setPosition(ccp(size.width*20/70,winSize.height*38/70));
    addChild(db,2);
...
void ASBotFightLayer::BladeMasterHitEnemyCritical(){
    ...
    CCCallFunc* remove = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::removeThis));
    CCCallFunc* smush = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::shadowSlash));
    ...
    CCCallFunc* unsche = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::endShadowSlash));
    CCSequence* seqCam = CCSequence::create(delay,unsche,NULL);
    CameraLayer->runAction(seqCam);
}

void ASBotFightLayer::shadowSlash(){
    unschedule(schedule_selector(ASBotFightLayer::shadowSlash));
    ...
    s1->setScale(2);
    s1->setPosition(ccp(-size.width*5/2,winSize.height/2));
    ...
    CCCallFunc* hit = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::shadowSlashHitEnemy));
    ...
    s2->setScaleY(2);
    s2->setScaleX(-2);
    s2->setPosition(ccp(-size.width*11/2,winSize.height/2));
    ...
    CCActionInterval* smush1 = CCMoveBy::create(0.8, ccp(size.width*3
                                                         , BotHero->getPosition().y - s2->getPosition().y));
    CCCallFunc* remove1 = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::removeThis));
    ...
    CCCallFunc* hit1 = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::shadowSlashHitEnemy));
    ...
    //3.循环
    schedule(schedule_selector(ASBotFightLayer::shadowSlash),0.4);
}

void ASBotFightLayer::shadowSlashHitEnemy(){
...
void ASBotFightLayer::endShadowSlash(){
    unschedule(schedule_selector(ASBotFightLayer::shadowSlash));
    schedule(schedule_selector(ASBotFightLayer::phoenixAttack),1);
}

void ASBotFightLayer::phoenixAttack(){
    
    unschedule(schedule_selector(ASBotFightLayer::phoenixAttack));
    ...
    CCCallFunc* hit = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::phoenixMinusHP));
    ...
    CCCallFunc* dragon = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::dragonAttack));
    CCSequence* seq = CCSequence::create(effect3,dragon,NULL);
    ph->runAction(seq);
}

void ASBotFightLayer::phoenixMinusHP(){
    ...
    hitEffect->setScaleX(5);
    hitEffect->setOpacity(200);
    hitEffect->setPosition(ccp(size.width/3,winSize.height*120/200));
    addChild(hitEffect,4);
...
void ASBotFightLayer::dragonAttack(){
    ...
    CCCallFunc* remove = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::removeThis));
    CCCallFunc* hit = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::dragonMinusHP));
    CCSequence* seq = CCSequence::create(moveDown,remove,hit,NULL);
    CCActionInterval* effect = CCSpawn::create(seq,pAnimate,NULL);
    dr->runAction(effect);
}

void ASBotFightLayer::dragonMinusHP(){
