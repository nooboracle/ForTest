...
void ASBotFightLayer::LichKingPreAttack(){
    ...
    blade->setPosition(ccp(size.width*37/50,winSize.height*9.7/20));
    addChild(blade,3);
...
void ASBotFightLayer::LichKingInAttack(){
    ...
    skillEffect_fly->setPosition(ccp(size.width/2,winSize.height/2));
    ...
    CCCallFunc* hit = CCCallFuncN::create(this, callfuncN_selector(ASBotFightLayer::LichKingHitEnemy));
