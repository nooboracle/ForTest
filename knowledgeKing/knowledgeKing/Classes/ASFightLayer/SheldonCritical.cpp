...
void ASFightLayer::SheldonInAttackCritical(){
    
    //1.镜头向右侧移动
    CCActionInterval* moveOut = CCMoveBy::create(1.2, ccp(-size.width*3, 0));
    CCCallFunc* hit = CCCallFuncN::create(this, callfuncN_selector(ASFightLayer::SheldonHitEnemyCritical));
...
void ASFightLayer::SheldonSecondHitEnemy(){
...
void ASFightLayer::InitSD(){
    ...
    //4. 我方超级英雄
    MainHero = CCSprite::createWithSpriteFrameName("Sheldon.png");
