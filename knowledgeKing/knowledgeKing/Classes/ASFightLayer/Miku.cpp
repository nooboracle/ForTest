...
void ASFightLayer::MikuPreAttack(){
    ...
    blade->setScale(1.5);
    blade->setPosition(ccp(size.width*13/50,winSize.height*9.5/20));
    addChild(blade,3);
...
void ASFightLayer::MikuInAttack(){
    ...
    cong2->setPosition(ccp(size.width*9/20,winSize.height*9/20));
    addChild(cong2,2);
    
    CCSprite* cong3 = CCSprite::createWithSpriteFrameName("cong.png");
    cong3->setPosition(ccp(size.width*8.5/20,winSize.height*11/20));
    addChild(cong3,2);
    ...
    CCCallFunc* hit1 = CCCallFuncN::create(this, callfuncN_selector(ASFightLayer::MikuHitEnemy));
    ...
    CCCallFunc* hit2 = CCCallFuncN::create(this, callfuncN_selector(ASFightLayer::MikuHitEnemy));
    ...
    CCCallFunc* hit3 = CCCallFuncN::create(this, callfuncN_selector(ASFightLayer::MikuHitEnemy));
    CCSequence* hitseq3 = CCSequence::create(moveBack3,moveSlowly5,moveSlowly6,hit3,NULL);
    cong3->runAction(hitseq3);
}

void ASFightLayer::MikuHitEnemy(CCNode* sender){
