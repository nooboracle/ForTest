...
- (void)viewDidLoad{
    ...
    _dmAdView = [[DMAdView alloc] initWithPublisherId:@"56OJzDQIuNML0+zvwI"
                                          placementId:@"16TLmiOoApORHNUGg4Jf6hik"
                                                 size:_adSize];
    ...
    DMTools *_dmTools = [[DMTools alloc] initWithPublisherId:@"56OJzDQIuNML0+zvwI"];
