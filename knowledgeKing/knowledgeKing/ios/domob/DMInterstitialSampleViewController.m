...
- (void)viewDidLoad{
    ...
    CGSize adSize;
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone){    adSize = DOMOB_AD_SIZE_300x250;     }
    else {      adSize = DOMOB_AD_SIZE_600x500;     }
    
    UIViewController *rootViewController = [UIApplication sharedApplication].keyWindow.rootViewController;
    
    //　初始化插屏广告，此处使用的是测试ID，请登陆多盟官网（www.domob.cn）获取新的ID
    // Get your own ID from Domob website
    _dmInterstitial = [[DMInterstitialAdController alloc] initWithPublisherId:@"56OJzDQIuNML0+zvwI"
                                                                  placementId:@"16TLmiOoApORHNUGgJp3fKxs"
